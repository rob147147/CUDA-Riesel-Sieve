...
cudaError_t addWithCuda(int *NOut, unsigned long long *KernelP, unsigned int size, const int blocks, const int threads, int *hashKeys, unsigned long long *hashValues, int hashTableElements);
...
__global__ void addKernel1(int *NOut, unsigned long long *KernelP, int *ks, int *Base, int *counterIn, int *hashKeys, unsigned long long *hashValues)
{
	...
	//unsigned long long int jsArray[512];
...
int main()
{
	...
	const int hashTableElements = 1024;
